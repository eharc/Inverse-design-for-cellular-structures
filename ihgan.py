# -*- coding: utf-8 -*-
"""
Created on Mon Jun 20 11:43:20 2022
...
class Model(object):
    ...
    def train(self, X_train, C_train, X_test, C_test, train_steps, batch_size=32, 
        ...
        for t in range(train_steps):
            ...
            # if (t+1) % train_steps == 0:
            #     for i in range(5):
            #         plt.figure(i)
            #         plt.plot(x_fake[:,i],color='red')
...
#        for i in range(5):
#            plt.figure(10+i)
#            plt.scatter(X[:,i],x_fake[:,i],marker='>',alpha=0.2)
